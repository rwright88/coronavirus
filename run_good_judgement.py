...
def get_data_manual():
    ...
    gl_cases = [
        ...
        ["2020-04-19", [0.01, 0.13, 0.59, 0.26], gl_cases_const],
    ]
    gl_deaths = [
        ...
        ["2020-04-19", [0.00, 0.09, 0.72, 0.17], gl_deaths_const],
    ]
    us_cases = [
        ...
        ["2020-04-19", [0.00, 0.02, 0.57, 0.40], us_cases_const],
    ]
    us_deaths = [
        ...
        ["2020-04-19", [0.00, 0.01, 0.73, 0.25], us_deaths_const],
    ]
    us_deaths_rel = [
        ...
        ["2020-04-19", [0.04, 0.24, 0.49, 0.20], us_deaths_rel_const],
    ]
